#' @title Simulation of continuous outcome in the paper
...
#'
#' @return
#' result_list: A list with three components.
#' \itemize{
...
Sim_continuous<-function(n,beta1,beta2,q,q1,q2,q3,c1,var_g,mu,mu1,sigma_y){
